...
from mmdet.ops import ContextBlock, DeformConv, ModulatedDeformConv, NonLocal2dGc
...
class BasicBlock(nn.Module):
    ...
    def __init__(self,
        ...
        assert nlgcb is None, "Not implemented yet."
