...
def conv_bn_relu(in_channels, out_channels, kernel_size=(1,1), stride=(1,1), norm_layer=nn.BatchNorm2d):
...
def conv_sigmoid(in_channels, out_channels, kernel_size=(1,1), stride=(1,1)):
    return nn.Sequential(
